...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Player songs={songs} setCurrentSong={setCurrentSong} audioRef={audioRef} songInfo={songInfo} setSongInfo={setSongInfo} isPlaying={isPlaying} setIsplaying={setIsPlaying} currentSong={currentSong}/>
